...
-- 슈퍼키 (SUPER Key) : 컬럼의 조합으로 독립적인 레코도를 구분할 수 있는 키
-- 후보키 (Candidate Key) : 최고한의 컬럼으로 레코드를 구분할 수 있는 키
...
INSERT INTO pk_table (other.column) VALUES(2);
...
-- 제약조건 수정
-- 1. ALTER 테이블명 MODIFY COLUMN 컬럼명 테이터타입 제약조건 
...
-- Error Code : 1452
-- 단, 해당 컬림이 NOT NULL이 아니라면 null은 지정할 수 있음 
