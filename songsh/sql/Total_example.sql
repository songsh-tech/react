...
-- 교사에 의해서 강의되어지며 여러명의 학생이 수업을 들을 수 있음
...
INSERT INTO teacher VALUES ('2000010101', '이방원', '대구광역시 달성구', '010-2222-3333', '일반교사');
INSERT INTO teacher VALUES ('2000010102', '이도', '부산광역시 부산진구', '010-2222-4444', '일반교사');
INSERT INTO teacher VALUES ('2000010103', '이향', '부산광역시 강서구', '010-2222-5555', '교생');
...
-- 5. 수업의 평균 점수가 80점 이상인 수업의 수업 이름과 담당 교사의 이름을 조회하는
...
-- 7. 평균 점수가(수학 + 국어 + 영어)가 90점 이상인
-- 학생이 수업중인 교실의 층 및 좌석수를 구하는 쿼리를 작성하시오.
SELECT 
	floor '층',
	seats '좌석 수'
FROM  class_room
